...
void GSettings::_register_methods() {
	...
	register_method("Save", &GSettings::_save);
...
Variant GSettings::get(String section, String key, Variant dfault) {
